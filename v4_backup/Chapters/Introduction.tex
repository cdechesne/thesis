...
\definecolor{perso}{RGB}{0,255,0}
\node[color=\col] at (0,1.5) {\textbf{Conifers: }};
\node[color=\col] at (0,1) {\textbf{920 millions m$^{2}$}};
\node[color=\col] at (0,-1) {\textbf{Hardwood: }};
\node[color=\col] at (0,-1.5) {\textbf{1647 millions m$^{2}$}};
