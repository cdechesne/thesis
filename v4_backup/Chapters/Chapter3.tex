...
\includegraphics[width=0.465\textwidth]{Figures/empty}
...
\\
\subfloat[Pixel-based classification.]{
\includegraphics[width=0.45\textwidth]{Figures/empty}
\label{subfig:C3_S3_ss3_poc}
}
\hspace*{0.025\textwidth}
\subfloat[Object-based classification (PFF).]{
\includegraphics[width=0.45\textwidth]{Figures/empty}
...
\begingroup
\captionsetup[subfigure]{width=0.45\textwidth}
\subfloat[Regularization using pixel-based classification.]{
\includegraphics[width=0.45\textwidth]{Figures/empty}
\label{subfig:C3_S3_ss3_rpoa}
}
\hspace*{0.025\textwidth}
\subfloat[Regularization using object-based classification (PFF).]{
\includegraphics[width=0.45\textwidth]{Figures/empty}
...
\begingroup
\captionsetup[subfigure]{width=0.45\textwidth}
\subfloat[Selected pixels; random selection.]{
\includegraphics[width=0.45\textwidth]{Figures/empty}
\label{subfig:C3_S3_ss_sela}
}
\hspace*{0.025\textwidth}
\subfloat[Selected pixels; automatic selection.]{
\includegraphics[width=0.45\textwidth]{Figures/empty}
