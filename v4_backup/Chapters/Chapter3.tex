...
\includegraphics[width=0.3\textwidth]{Figures/empty}
...
\hspace*{0.025\textwidth}
\subfloat[Object-based classification (PFF) (overall accuracy: 90.22\%, $\kappa$: 0.81).]{
...
\hspace*{0.025\textwidth}
\subfloat[Regularization using object-based classification (PFF) (overall accuracy: 96.58\%, $\kappa$: 0.93).]{
...
\begingroup
\captionsetup[subfigure]{width=0.45\textwidth}
\subfloat[Classification with selection of training pixels  (overall accuracy: 90.22\%, $\kappa$: 0.81).]{
\includegraphics[width=0.45\textwidth]{Figures/C3/S3/ss3/classif_PFF}
\label{subfig:C3_S3_ss3_sel_resultsa}
}
\hspace*{0.025\textwidth}
\subfloat[Regularization  with selection of training pixels (overall accuracy: 96.58\%, $\kappa$: 0.93).]{
\includegraphics[width=0.45\textwidth]{Figures/C3/S3/ss3/regul_PFF}
...
\includegraphics[width=0.45\textwidth]{Figures/empty}
