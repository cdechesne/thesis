...
grow cyclic,
level 1/.append style={level distance=5cm,sibling angle=75},
level 2/.append style={level distance=4cm,sibling angle=45},] 
node[concept,grow=90] {Forest analysis} 
[clockwise from=0] 
child[concept color=green!50!black] { 
node[concept, text width=3cm] {Stand \\ segmentation} 
[clockwise from=60] 
child { node[concept] {Optical} } 
child { node[concept,grow=90] {Lidar } }
child { node[concept] {Optical \& Lidar} } 
}
child[concept color=blue] { 
node[concept] {Segmentation} 
[clockwise from=0] 
child { node[concept] {Point cloud} }
child { node[concept] {"Tradidional"} } 
child { node[concept] {Superpixels} }
} 
child[concept color=blue!50!red] { 
node[concept] {Classification} 
} 
child[concept color=red] {
node[concept] {Dimension reduction}
[clockwise from=-60] 
child { node[concept] {Feature extraction} }
child { node[concept] {Feature selection} }
}
child[concept color=orange] {
node[concept] {Smoothing}
[clockwise from=90] 
